!(function (t, e) {
  ...
  function o(t) {
    ...
    for (
      var n = r(10) ? document.body : null, i = t.offsetParent;
  ...
  function a(t, e) {
    ...
    if ((t !== f && e !== f) || i.contains(r))
      return (
        (c = f),
        (h = c.nodeName),
        "BODY" === h || ("HTML" !== h && o(c.firstElementChild) !== c)
          ? o(f)
          : f
      );
    var u = s(t);
  ...
  function p(t, n) {
    ...
    o &&
      "HTML" === n.nodeName &&
      ((h.top = H(h.top, 0)), (h.left = H(h.left, 0)));
    var _ = u({
      top: c.top - h.top - g,
  ...
  function m(t, r, o, s) {
    ...
    if ("viewport" === s)
      ...
      var m;
      "scrollParent" === s
        ? "BODY" === (m = i(n(r))).nodeName &&
          (m = t.ownerDocument.documentElement)
        : (m = "window" === s ? t.ownerDocument.documentElement : s);
      var _ = p(m, d, c);
      if (
        "HTML" !== m.nodeName ||
        (function t(i) {
        ...
        var v = f(),
          E = v.height,
          y = v.width;
        (h.top += _.top - _.marginTop),
          (h.bottom = E + _.top),
          (h.left += _.left - _.marginLeft),
          (h.right = y + _.left);
      }
    }
  ...
  function C(e, n, i) {
    return (
      (void 0 === i
        ...
        e.enabled &&
          t(i) &&
          ((n.offsets.popper = u(n.offsets.popper)),
          (n.offsets.reference = u(n.offsets.reference)),
          (n = i(n, e)));
      }),
      n
    );
  ...
  function A(t, e, n, r) {
    (n.updateBound = r),
      D(t).addEventListener("resize", n.updateBound, { passive: !0 });
    var o = i(t);
    return (
      (function t(e, n, r, o) {
  ...
  for (
    ...
    if (F && 0 <= navigator.userAgent.indexOf(W[U])) {
      M = 1;
      break;
    }
  var B =
    ...
    tt = (function () {
      function e(n, i) {
        ...
        Q(this, e),
          ...
          (this.options = q({}, e.Defaults, o)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = n && n.jquery ? n[0] : n),
          (this.popper = i && i.jquery ? i[0] : i),
          (this.options.modifiers = {}),
          Object.keys(q({}, e.Defaults.modifiers, o.modifiers)).forEach(
            function (t) {
              r.options.modifiers[t] = q(
                {},
        ...
        arrow: {
          ...
          fn: function (t, n) {
            ...
            l[g] - m < a[d] && (t.offsets.popper[d] -= a[d] - (l[g] - m)),
              ...
              (t.offsets.popper = u(t.offsets.popper));
            var _ = l[d] + l[h] / 2 - m / 2,
            ...
            return (
              (T = H(x(a[h] - m, T), 0)),
              (t.arrowElement = r),
              (t.offsets.arrow = (G((i = {}), d, j(T)), G(i, p, ""), i)),
              t
            );
          },
          element: "[x-arrow]",
            ...
            return (
              s.forEach(function (a, l) {
                ...
                (d || v || T) &&
                  ...
                  (t = C(t.instance.modifiers, t, "flip")));
              }),
              t
            );
          },
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            var a,
              ...
              m = I("transform");
            if (
              ((l = "bottom" == p ? -h.height + u.bottom : u.top),
              (a = "right" == g ? -h.width + u.right : u.left),
              c && m)
            )
              (f[m] = "translate3d(" + a + "px, " + l + "px, 0)"),
                (f[p] = 0),
                (f[g] = 0),
            ...
            return (
              (t.attributes = q({}, E, t.attributes)),
              (t.styles = q({}, f, t.styles)),
  ...
  (function (t, e) {
    ...
    var s,
      ...
      on =
          ...
          return (
            ...
            (e._getRootElement = function (t) {
              var e = rn.getSelectorFromElement(t),
                n = !1;
              return (
                e && (n = s(e)[0]), n || (n = s(t).closest(".alert")[0]), n
              );
            }),
            ...
            (e._removeElement = function (t) {
              ...
              if ((s(t).removeClass("show"), s(t).hasClass("fade"))) {
                ...
                s(t)
                  .one(rn.TRANSITION_END, function (n) {
        ...
        (s.fn[a] = u._jQueryInterface),
        (s.fn[a].Constructor = u),
      ...
      sn =
        ...
        (I = (function () {
          ...
          return (
            (e.toggle = function () {
                ...
                if (i) {
                  ...
                  if (t) {
                    if (
                      ...
                      return;
                    (i.checked = !d(this._element).hasClass(E)),
                      d(i).trigger("change");
                  }
                  i.focus(), (e = !1);
                }
              ...
              e &&
                this._element.setAttribute(
                  "aria-pressed",
                  !d(this._element).hasClass(E)
                ),
                t && d(this._element).toggleClass(E);
            }),
            (e.dispose = function () {
            ...
            (t._jQueryInterface = function (e) {
              return this.each(function () {
                var n = d(this).data(g);
                n || ((n = new t(this)), d(this).data(g, n)),
                  "toggle" === e && n[e]();
              });
            }),
            r(t, null, [
        ...
        d(document)
          .on(w.CLICK_DATA_API, y, function (t) {
            t.preventDefault();
            var e = t.target;
            d(e).hasClass("btn") || (e = d(e).closest(C)),
              I._jQueryInterface.call(d(e), "toggle");
          })
          .on(w.FOCUS_BLUR_DATA_API, y, function (t) {
            var e = d(t.target).closest(C)[0];
            d(e).toggleClass("focus", /^focus(in)?$/.test(t.type));
          }),
        (d.fn[p] = I._jQueryInterface),
        (d.fn[p].Constructor = I),
      ...
      an =
        ...
        (V = (function () {
          function t(t, e) {
            (this._items = null),
              ...
              (this._element = D(t)[0]),
              (this._indicatorsElement = D(this._element).find(
                K.INDICATORS
              )[0]),
          ...
          return (
            ...
            (e.pause = function (t) {
              t || (this._isPaused = !0),
                D(this._element).find(K.NEXT_PREV)[0] &&
                  (rn.triggerTransitionEnd(this._element), this.cycle(!0)),
              ...
              this._config.keyboard &&
                ...
                "hover" === this._config.pause &&
                  ...
                  "ontouchstart" in document.documentElement &&
                    D(this._element).on(R.TOUCHEND, function () {
                      t.pause(),
            ...
            (e._getItemIndex = function (t) {
              return (
                (this._items = D.makeArray(D(t).parent().find(K.ITEM))),
            ...
            (e._slide = function (t, e) {
              ...
              if (
                ...
                if (D(this._element).hasClass("slide")) {
                  ...
                  D(s)
                    .one(rn.TRANSITION_END, function () {
                      D(l)
                        .removeClass(n + " " + i)
                        .addClass(F),
                        D(s).removeClass(F + " " + i + " " + n),
                        (o._isSliding = !1),
                        setTimeout(function () {
            ...
            (t._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  (n || ((n = new t(this, i)), D(this).data(S, n)),
                  "number" == typeof e)
                )
                  n.to(e);
        ...
        D(document).on(R.CLICK_DATA_API, K.DATA_SLIDE, V._dataApiClickHandler),
        ...
        (D.fn[A] = V._jQueryInterface),
        (D.fn[A].Constructor = V),
        (D.fn[A].noConflict = function () {
      ...
      ln =
        ...
        (ot = (function () {
          ...
          return (
              ...
              if (
                !(
                  ...
                  (this._parent &&
                    ...
                    (e = null),
                  e &&
                    (n = Q(e).not(this._selector).data(G)) &&
                    n._isTransitioning)
                )
              ) {
                ...
                if ((Q(this._element).trigger(r), !r.isDefaultPrevented())) {
                  ...
                  Q(this._element).removeClass(tt).addClass(et),
                  ...
                  Q(this._element)
                    .one(rn.TRANSITION_END, function () {
                      Q(i._element).removeClass(et).addClass(tt).addClass($),
                        (i._element.style[o] = ""),
                        i.setTransitioning(!1),
                        Q(i._element).trigger(Z.SHOWN);
                    })
                ...
                if ((Q(this._element).trigger(e), !e.isDefaultPrevented())) {
                  ...
                  if (
                    ...
                    for (var i = 0; i < this._triggerArray.length; i++) {
                      ...
                      null !== o &&
                        (Q(o).hasClass($) ||
                          Q(r).addClass(nt).attr("aria-expanded", !1));
                    }
            ...
            (e._getConfig = function (t) {
              return (
                ((t = o({}, X, t)).toggle = Boolean(t.toggle)),
                rn.typeCheckConfig(Y, t, J),
                t
              );
            }),
            ...
            (e._getParent = function () {
              var e = this,
                n = null;
              rn.isElement(this._config.parent)
                ? ((n = this._config.parent),
                  void 0 !== this._config.parent.jquery &&
                    (n = this._config.parent[0]))
                : (n = Q(this._config.parent)[0]);
              var i =
            ...
            (e._addAriaAndCollapsedClass = function (t, e) {
              if (t) {
                var n = Q(t).hasClass($);
                0 < e.length &&
                  Q(e).toggleClass(nt, !n).attr("aria-expanded", n);
              }
            }),
        ...
        (Q.fn[Y] = ot._jQueryInterface),
        (Q.fn[Y].Constructor = ot),
      ...
      cn =
        ...
        (Pt = (function () {
          ...
          return (
                  ...
                  if ((st(e).trigger(o), !o.isDefaultPrevented())) {
                    if (!this._inNavbar) {
                      ...
                      "parent" === this._config.reference
                        ? (s = e)
                        : rn.isElement(this._config.reference) &&
                    ...
                    "ontouchstart" in document.documentElement &&
                      0 === st(e).closest(Ct).length &&
                      st(document.body)
                        .children()
                        .on("mouseover", null, st.noop),
                      this._element.focus(),
                      this._element.setAttribute("aria-expanded", !0),
                      st(this._menu).toggleClass(gt),
                      st(e).toggleClass(gt).trigger(st.Event(dt.SHOWN, r));
                  }
                }
              }
            }),
            ...
            (e._getConfig = function (t) {
              return (
                (t = o(
                  ...
                  st(this._element).data(),
                  t
                )),
                rn.typeCheckConfig(at, t, this.constructor.DefaultType),
                t
              );
            }),
            ...
            (e._getPlacement = function () {
              ...
              return (
                t.hasClass("dropup")
                  ? ((e = It), st(this._menu).hasClass(vt) && (e = Dt))
                  : t.hasClass(mt)
                  ? (e = Ot)
                  : t.hasClass(_t)
                  ? (e = Nt)
                  : st(this._menu).hasClass(vt) && (e = St),
                e
              );
            }),
            ...
            (t._clearMenus = function (e) {
              if (
                ...
                for (var n = st.makeArray(st(yt)), i = 0; i < n.length; i++) {
                      ...
                      st(r).trigger(l),
                        l.isDefaultPrevented() ||
                          ("ontouchstart" in document.documentElement &&
                            st(document.body)
                              .children()
                              .off("mouseover", null, st.noop),
                          n[i].setAttribute("aria-expanded", "false"),
                          st(a).removeClass(gt),
                          st(r)
                            .removeClass(gt)
                            .trigger(st.Event(dt.HIDDEN, s)));
                    }
                  }
                }
            }),
                  ...
                  ? !(
                      ...
                      (27 !== e.which &&
                        ((40 !== e.which && 38 !== e.which) ||
                          st(e.target).closest(Tt).length))
                    )
                  : ut.test(e.which)) &&
                (e.preventDefault(),
                e.stopPropagation(),
                !this.disabled && !st(this).hasClass(pt))
              ) {
        ...
        st(document)
          .on(dt.KEYDOWN_DATA_API, yt, Pt._dataApiKeydownHandler)
          .on(dt.KEYDOWN_DATA_API, Tt, Pt._dataApiKeydownHandler)
          .on(dt.CLICK_DATA_API + " " + dt.KEYUP_DATA_API, Pt._clearMenus)
          .on(dt.CLICK_DATA_API, yt, function (t) {
            t.preventDefault(),
              t.stopPropagation(),
              Pt._jQueryInterface.call(st(this), "toggle");
          })
          .on(dt.CLICK_DATA_API, bt, function (t) {
            t.stopPropagation();
          }),
        (st.fn[at] = Pt._jQueryInterface),
        (st.fn[at].Constructor = Pt),
      ...
      hn =
        ...
        (qt = (function () {
          function t(t, e) {
            (this._config = this._getConfig(e)),
              (this._element = t),
              (this._dialog = xt(t).find(Gt.DIALOG)[0]),
              (this._backdrop = null),
              (this._isShown = !1),
          ...
          return (
            ...
            (e.show = function (t) {
              ...
              if (!this._isTransitioning && !this._isShown) {
                ...
                var n = xt.Event(Ut.SHOW, { relatedTarget: t });
                xt(this._element).trigger(n),
                  this._isShown ||
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    this._setEscapeEvent(),
                    this._setResizeEvent(),
                    xt(document).off(Ut.FOCUSIN),
                    xt(this._element).removeClass(Yt),
                    xt(this._element).off(Ut.CLICK_DISMISS),
                    xt(this._dialog).off(Ut.MOUSEDOWN_DISMISS),
                    i)
                  ) {
                    var r = rn.getTransitionDurationFromElement(this._element);
                    xt(this._element)
                      .one(rn.TRANSITION_END, function (t) {
            ...
            (e.dispose = function () {
              xt.removeData(this._element, Rt),
                xt(window, document, this._element, this._backdrop).off(Ht),
                (this._config = null),
                (this._element = null),
                (this._dialog = null),
                (this._backdrop = null),
            ...
            (e._showElement = function (t) {
              ...
              (this._element.parentNode &&
                ...
                n && rn.reflow(this._element),
                xt(this._element).addClass(Yt),
                this._config.focus && this._enforceFocus();
              var i = xt.Event(Ut.SHOWN, { relatedTarget: t }),
                r = function () {
                  e._config.focus && e._element.focus(),
                    (e._isTransitioning = !1),
                    xt(e._element).trigger(i);
                };
              if (n) {
                var o = rn.getTransitionDurationFromElement(this._element);
                xt(this._dialog)
                  .one(rn.TRANSITION_END, r)
            ...
            (e._enforceFocus = function () {
              ...
              xt(document)
                .off(Ut.FOCUSIN)
                .on(Ut.FOCUSIN, function (e) {
                  document !== e.target &&
                    t._element !== e.target &&
                    0 === xt(t._element).has(e.target).length &&
                    t._element.focus();
                });
            }),
            (e._setEscapeEvent = function () {
              ...
              this._isShown && this._config.keyboard
                ? xt(this._element).on(Ut.KEYDOWN_DISMISS, function (e) {
            ...
            (e._setResizeEvent = function () {
              var t = this;
              this._isShown
                ? xt(window).on(Ut.RESIZE, function (e) {
            ...
            (e._hideModal = function () {
              ...
              (this._element.style.display = "none"),
                ...
                (this._isTransitioning = !1),
                this._showBackdrop(function () {
                  xt(document.body).removeClass(Vt),
                    t._resetAdjustments(),
                    t._resetScrollbar(),
                    xt(t._element).trigger(Ut.HIDDEN);
                });
            }),
            (e._removeBackdrop = function () {
              this._backdrop &&
                (xt(this._backdrop).remove(), (this._backdrop = null));
            }),
            (e._showBackdrop = function (t) {
              ...
              if (this._isShown && this._config.backdrop) {
                if (
                  ...
                  (this._backdrop.className = Kt),
                  n && xt(this._backdrop).addClass(n),
                  xt(this._backdrop).appendTo(document.body),
                  xt(this._element).on(Ut.CLICK_DISMISS, function (t) {
                  ...
                  n && rn.reflow(this._backdrop),
                  xt(this._backdrop).addClass(Yt),
                  !t)
                )
                  return;
                if (!n) return void t();
            ...
            (e._resetScrollbar = function () {
              xt(Gt.FIXED_CONTENT).each(function (t, e) {
                ...
                void 0 !== n &&
                  xt(e).css("padding-right", n).removeData("padding-right");
              }),
                xt(Gt.STICKY_CONTENT + ", " + Gt.NAVBAR_TOGGLER).each(function (
                  t,
                  e
                ) {
                  var n = xt(e).data("margin-right");
                  void 0 !== n &&
                    xt(e).css("margin-right", n).removeData("margin-right");
                });
            ...
            (t._jQueryInterface = function (e, n) {
              return this.each(function () {
                ...
                if (
                  (i || ((i = new t(this, r)), xt(this).data(Rt, i)),
                  "string" == typeof e)
                ) {
                  if (void 0 === i[e])
                    throw new TypeError('No method named "' + e + '"');
        ...
        (xt.fn[jt] = qt._jQueryInterface),
        (xt.fn[jt].Constructor = qt),
        (xt.fn[jt].noConflict = function () {
      ...
      fn =
          ...
          return (
              ...
              if (this._isEnabled)
                if (t) {
                  ...
                  n ||
                    ...
                    zt(t.currentTarget).data(e, n)),
                    (n._activeTrigger.click = !n._activeTrigger.click),
                    n._isWithActiveTrigger()
                      ? n._enter(null, n)
                      : n._leave(null, n);
                } else {
                  if (zt(this.getTipElement()).hasClass(ce))
            ...
            (e.dispose = function () {
              clearTimeout(this._timeout),
                zt.removeData(this.element, this.constructor.DATA_KEY),
                zt(this.element).off(this.constructor.EVENT_KEY),
                zt(this.element).closest(".modal").off("hide.bs.modal"),
                this.tip && zt(this.tip).remove(),
            ...
            (e.show = function () {
              var t = this;
              if ("none" === zt(this.element).css("display"))
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                r.setAttribute("id", o),
                  ...
                  this.setContent(),
                  this.config.animation && zt(r).addClass(le);
                var s =
                ...
                var l =
                  !1 === this.config.container
                    ? document.body
                    : zt(this.config.container);
                zt(r).data(this.constructor.DATA_KEY, this),
                  zt.contains(
                    this.element.ownerDocument.documentElement,
                    this.tip
                  ) || zt(r).appendTo(l),
                  zt(this.element).trigger(this.constructor.Event.INSERTED),
                  ...
                  zt(r).addClass(ce),
                  "ontouchstart" in document.documentElement &&
                    zt(document.body).children().on("mouseover", null, zt.noop);
                var c = function () {
                  t.config.animation && t._fixTransition();
                  var e = t._hoverState;
                  (t._hoverState = null),
                    zt(t.element).trigger(t.constructor.Event.SHOWN),
                    e === se && t._leave(null, t);
                };
                if (zt(this.tip).hasClass(le)) {
                  var h = rn.getTransitionDurationFromElement(this.tip);
                  zt(this.tip)
                    .one(rn.TRANSITION_END, c)
              ...
              var e = this,
                ...
                r = function () {
                  e._hoverState !== oe &&
                    ...
                    zt(e.element).trigger(e.constructor.Event.HIDDEN),
            ...
            (e.getTipElement = function () {
              return (
                (this.tip = this.tip || zt(this.config.template)[0]), this.tip
              );
            }),
            ...
            (e.setElementContent = function (t, e) {
              ...
              "object" == typeof e && (e.nodeType || e.jquery)
                ? n
                  ? zt(e).parent().is(t) || t.empty().append(e)
                  : t.text(zt(e).text())
                : t[n ? "html" : "text"](e);
            }),
            (e.getTitle = function () {
            ...
            (e._enter = function (t, e) {
              ...
              (e = e || zt(t.currentTarget).data(n)) ||
                ((e = new this.constructor(
                  t.currentTarget,
                  this._getDelegateConfig()
                )),
                zt(t.currentTarget).data(n, e)),
                t && (e._activeTrigger["focusin" === t.type ? ue : fe] = !0),
                zt(e.getTipElement()).hasClass(ce) || e._hoverState === oe
                  ? (e._hoverState = oe)
            ...
            (e._leave = function (t, e) {
              ...
              (e = e || zt(t.currentTarget).data(n)) ||
                ...
                zt(t.currentTarget).data(n, e)),
                t && (e._activeTrigger["focusout" === t.type ? ue : fe] = !1),
              ...
              return (
                "number" ==
                  typeof (t = o(
                    {},
                    this.constructor.Default,
                    zt(this.element).data(),
                    "object" == typeof t && t ? t : {}
                  )).delay && (t.delay = { show: t.delay, hide: t.delay }),
                "number" == typeof t.title && (t.title = t.title.toString()),
                "number" == typeof t.content &&
                  (t.content = t.content.toString()),
                rn.typeCheckConfig(Xt, t, this.constructor.DefaultType),
                t
              );
            }),
            ...
            (t._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  ...
                  (n || ((n = new t(this, i)), zt(this).data(Jt, n)),
                  "string" == typeof e)
                ) {
                  if (void 0 === n[e])
                    throw new TypeError('No method named "' + e + '"');
        ...
        (zt.fn[Xt] = de._jQueryInterface),
        (zt.fn[Xt].Constructor = de),
        (zt.fn[Xt].noConflict = function () {
      ...
      un =
        ...
        (Te = o({}, fn.DefaultType, { content: "(string|element|function)" })),
        "fade",
        (Ce = ".popover-header"),
        (we = ".popover-body"),
        (Ie = {
          ...
          return (
            ...
            (o.setContent = function () {
              ...
              "function" == typeof e && (e = e.call(this.element)),
                this.setElementContent(t.find(we), e),
            ...
            (i._jQueryInterface = function (t) {
              return this.each(function () {
                ...
                if (
                  ...
                  (e || ((e = new i(this, n)), pe(this).data(me, e)),
                  "string" == typeof t)
                ) {
                  if (void 0 === e[t])
        ...
        (pe.fn[ge] = De._jQueryInterface),
        (pe.fn[ge].Constructor = De),
        (pe.fn[ge].noConflict = function () {
      ...
      dn =
        ...
        (We = (function () {
          function t(t, e) {
            ...
            (this._element = t),
              ...
              Ae(this._scrollElement).on(xe.SCROLL, function (t) {
                return n._process(t);
              }),
              this.refresh(),
              this._process();
          ...
          return (
            (e.refresh = function () {
              ...
              (this._offsets = []),
                ...
                Ae.makeArray(Ae(this._selector))
                  .map(function (t) {
                    var e,
            ...
            (e.dispose = function () {
              Ae.removeData(this._element, Oe),
                Ae(this._scrollElement).off(Ne),
                (this._element = null),
            ...
            (e._getConfig = function (t) {
              if (
                ...
                e || ((e = rn.getUID(Se)), Ae(t.target).attr("id", e)),
                  (t.target = "#" + e);
              }
            ...
            (e._activate = function (t) {
              ...
              var n = Ae(e.join(","));
              n.hasClass(je)
                ? (n.closest(He.DROPDOWN).find(He.DROPDOWN_TOGGLE).addClass(Re),
                  n.addClass(Re))
                : (n.addClass(Re),
                  n
                    .parents(He.NAV_LIST_GROUP)
                    .prev(He.NAV_LINKS + ", " + He.LIST_ITEMS)
                    .addClass(Re),
                  n
                    .parents(He.NAV_LIST_GROUP)
                    .prev(He.NAV_ITEMS)
                    .children(He.NAV_LINKS)
                    .addClass(Re)),
                Ae(this._scrollElement).trigger(xe.ACTIVATE, {
                  relatedTarget: t,
                });
            }),
            (e._clear = function () {
        ...
        (Ae.fn[Se] = We._jQueryInterface),
        (Ae.fn[Se].Constructor = We),
      ...
      pn =
        ...
        (nn = (function () {
          ...
          return (
            (e.show = function () {
              ...
              if (
                !(
                  (this._element.parentNode &&
                    this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
                    Me(this._element).hasClass(Ye)) ||
                  Me(this._element).hasClass(Ge)
                )
              ) {
                var e,
                  n,
                ...
                var s = Me.Event(Ve.HIDE, { relatedTarget: this._element }),
                  a = Me.Event(Ve.SHOW, { relatedTarget: n });
                if (
                  (n && Me(n).trigger(s),
                  ...
                  var l = function () {
                    var e = Me.Event(Ve.HIDDEN, { relatedTarget: t._element }),
                      i = Me.Event(Ve.SHOWN, { relatedTarget: n });
            ...
            (e._activate = function (t, e, n) {
              var i = this,
                r = (
                  "UL" === e.nodeName ? Me(e).find(Ze) : Me(e).children(Je)
                )[0],
            ...
            (e._transitionComplete = function (t, e, n) {
              ...
              if (
                ...
                rn.reflow(t),
                Me(t).addClass(qe),
                t.parentNode && Me(t.parentNode).hasClass(Qe))
              ) {
                var r = Me(t).closest(ze)[0];
                r && Me(r).find(tn).addClass(Ye),
        ...
        (Me.fn.tab = nn._jQueryInterface),
        (Me.fn.tab.Constructor = nn),
